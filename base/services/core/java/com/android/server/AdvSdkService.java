...
/********************************** UI ---- Navigation Bar ********************************************/
    ...
    public boolean isBackButtonShow() {
        return SystemProperties.getInt("persist.navbar.back", 0) != 2 ;
    }
    ...
    public boolean isHomeButtonShow() {
        return SystemProperties.getInt("persist.navbar.home", 0) != 2 ;
    }
    ...
    public boolean isRecentButtonShow() {
        return SystemProperties.getInt("persist.navbar.recent", 0) != 2 ;
    }
...
/************************************** UI ---- private functions *************************************/
	...
	int flags = StatusBarManager.DISABLE_NONE;
        if (SystemProperties.getInt("persist.navbar.back", 0) == 2) {
                flags |= StatusBarManager.DISABLE_BACK;
        }
        if (SystemProperties.getInt("persist.navbar.home", 0) == 2) {
...
/***************************************** Device ---- Apps ******************************************/
    ...
    public void enableManagedAppInfoPage(boolean enabling) {
        SystemProperties.set("persist.setting.manageapp", enabling ? "1" : "2");
    }

    public boolean isManagedAppInfoPageEnabled() {
        return SystemProperties.getInt("persist.setting.manageapp", 0) != 2;
    }
